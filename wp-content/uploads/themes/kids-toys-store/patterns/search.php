 ...
 * Search Section
 * 
 * slug: kids-toys-store/search-page
 * title: Search Page
 * categories: kids-toys-store
 */

return array(
    'title'      =>__( 'Search Page', 'kids-toys-store' ),
...
<h2 class="wp-block-heading has-text-align-center">'. esc_html__(' No results found','kids-toys-store') .'</h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"> '. esc_html__('  We could not find any posts matching your search. Try different keywords.','kids-toys-store') .'</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
